...
export default function RSVPSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Datos del formulario (demo):", endpointData);
      setIsSubmitted(true);
    } catch (error) {
      console.error("Error simulado:", error);
      alert("Error de conexión simulado. Por favor intenta nuevamente.");
    } finally {
      setIsLoading(false);
    }
  };
    ...
    return (
      <section id="rsvp" className="py-16 px-4 bg-[#781207] text-white">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h2 className="text-4xl font-serif font-bold mb-6 text-[#f3c374]">
          ...
          <Button
            ...
            className="bg-[#f3c374] text-[#781207] hover:bg-[#f3c374]/90"
          >
            Modificar respuesta
          </Button>
        </div>
    ...
    <section id="rsvp" className="py-16 px-4 bg-[#781207] text-white">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-serif font-bold mb-4 text-[#f3c374]">
            Confirmación de Asistencia
          </h2>
          <p className="text-xl opacity-90">
            Por favor confirmá tu asistencia antes del 25 de octubre
          </p>
        </div>
          ...
          <CardContent className="p-0">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-semibold text-[#781207] mb-4">
                  Información Personal
                </h3>
                ...
                <div>
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="si" className="text-gray-700">
                        Sí, asistiré
                      </Label>
                    </div>
                    <div className="flex items-center space-x-2">
                    ...
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="tal vez" id="tal-vez" />
                      <Label htmlFor="tal-vez" className="text-gray-700">
                ...
                {formData.attendance === "si" && (
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleInputChange("confirmados", e.target.value)
                      } // updated field name
